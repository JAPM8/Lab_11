...
void main(void) {
    ...
    while(1){        
        ...
        // cambio en el selector (SS) para generar respuesta del pic MCU2
        ...
        // cambio en el selector (SS) para generar respuesta del pic MCU3
        PORTAbits.RA6 = 1;      // Deshabilitamos el ss del esclavo MCU3
        __delay_ms(10);         // Delay para que el PIC pueda detectar el cambio en el pin
        PORTD = SSPBUF;
